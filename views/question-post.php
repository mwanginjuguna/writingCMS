    ...
    <div class="body-content">
        <div class="question-details">
            ...
            <p class="question-excerpt">
                <?php
                $question->setQuestionExcerpt();
                echo $question->questionExcerpt;
                ?>
            </p>
            <div class="question-meta">
                <p class="question-category"><span style="font-weight: bold;">Category: </span> <?php echo $question->category; ?></p>
        ...
        <div class="question-body" style="white-space: pre-line">
            ...
            <p><a href="<?= $config['orderLink'] ?>">Order an Original Solution</a></p>
        </div>
    </div>
